...
class ArriendosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arriendo" do
    assert_difference("Arriendo.count") do
      post arriendos_url, params: { arriendo: { cliente_id: @arriendo.cliente_id, pelicula_id: @arriendo.pelicula_id } }
    end
  ...
  test "should update arriendo" do
    patch arriendo_url(@arriendo), params: { arriendo: { cliente_id: @arriendo.cliente_id, pelicula_id: @arriendo.pelicula_id } }
